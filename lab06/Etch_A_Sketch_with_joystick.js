/*
 Program- Joystick Etch a Sketch
 Author- Mohit Sharma
...
var x = new Array(gridSize);           //defining the grid
...
function gridPrint(){
  ...
  for(var i=0;i<gridSize;i++) combinedString0+=i+1+"\t";  //setting values high for glowing
...
function yPos(x) {
	pos.y = parseFloat(x.value).toFixed(2);  //position y
	takeAction();
}
